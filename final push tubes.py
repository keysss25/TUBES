...
def tambah_pakaian():
    ...
    print("\n[OK] Pakaian berhasil ditambahkan [OK]")
...
def selection_sort_formalitas():
    ...
    print("\n[OK] Lemari berhasil diurutkan dari yang Paling Formal ke Casual. [OK]")
    lihat_lemari()
...
def insertion_sort_tanggal():
    ...
    print("\n[OK] Lemari berhasil diurutkan berdasarkan Tanggal Terlama (Rotasi Baju). [OK]")
    lihat_lemari()
